...
export const vleencoder_encode_u32: (a: number) => number;
export const vleencoder_encode_u16: (a: number) => number;
export const vleencoder_decode_u32: (a: number, b: number) => number;
export const vleencoder_decode_u16: (a: number, b: number) => number;
export const vleencoder_encoded_size_u32: (a: number) => number;
export const vleencoder_encoded_size_u16: (a: number) => number;
export const parameterencoder_encode_execute_vle: (a: number, b: number, c: number) => void;
