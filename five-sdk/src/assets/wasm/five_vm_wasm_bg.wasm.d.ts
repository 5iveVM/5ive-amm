...
export const testresult_final_memory: (a: number) => any;
export const testresult_final_accounts: (a: number) => any;
...
export const wasmsuggestion_code_suggestion: (a: number) => [number, number];
...
export const wasmcompilererror_line: (a: number) => any;
export const wasmcompilererror_column: (a: number) => any;
...
export const wasmcompilererror_source_line: (a: number) => [number, number];
...
export const wasmcompilationresult_abi: (a: number) => any;
...
export const wasmcompilationresult_get_formatted_errors_terminal: (a: number) => [number, number];
export const wasmcompilationresult_get_formatted_errors_json: (a: number) => [number, number];
...
export const wasmfivecompiler_format_error_terminal: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => [number, number];
