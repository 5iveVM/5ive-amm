...
/// Enhanced stack size for function calls (restored for better performance)
...
/// Increased from 8 to 16 to support deeper nesting with multiple locals per frame
/// Increased from 8 to 12 (reduced from 16 to fix stack overflow)
pub const MAX_LOCALS: usize = 12;
