...
export const __wbg_fivelspwasm_free: (a: number, b: number) => void;
export const fivelspwasm_new: () => number;
export const fivelspwasm_get_diagnostics: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const fivelspwasm_get_hover: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
export const fivelspwasm_get_completions: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
export const fivelspwasm_get_definition: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
