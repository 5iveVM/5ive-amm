                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-1 relative">
                        ...
                        <motion.div
                            ...
                            className="rounded-3xl border border-rose-pine-hl-low/20 bg-rose-pine-surface shadow-2xl overflow-hidden p-6 md:p-8"
                        >
                            <div className="space-y-8">

                                {/* Timeline 1: Anchor (Slow) */}
                                <div>
                                    <div className="flex justify-between text-xs font-mono text-rose-pine-subtle mb-2 uppercase tracking-widest opacity-70 text-contrast">
                                        <span>Typical Anchor Program</span>
                                        <span>~5000 CU</span>
                                    </div>
                                    <div className="h-12 w-full flex rounded-lg overflow-hidden border border-rose-pine-hl-low/10 bg-rose-pine-base">
                                        {/* Discriminator */}
                                        <div className="h-full bg-rose-pine-text/20 w-[15%] border-r border-rose-pine-surface relative group">
                                            <div className="absolute inset-0 flex items-center justify-center text-[10px] text-rose-pine-subtle font-mono text-contrast">Check</div>
                                            <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-rose-pine-overlay px-2 py-1 rounded text-[10px] text-rose-pine-text opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-rose-pine-hl-low/20">
                                                Discriminator Check
                                            </div>
                                        </div>
                                        {/* Deserialization */}
                                        <div className="h-full bg-rose-pine-iris/20 w-[40%] border-r border-rose-pine-surface relative group">
                                            <div className="absolute inset-0 flex items-center justify-center text-[10px] text-rose-pine-iris font-mono text-contrast">Borsh Deserialize</div>
                                            <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-rose-pine-overlay px-2 py-1 rounded text-[10px] text-rose-pine-text opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-rose-pine-hl-low/20">
                                                Arg Deserialization Overhead
                                            </div>
                                        </div>
                                        {/* Logic */}
                                        <div className="h-full bg-rose-pine-gold/20 w-[25%] border-r border-rose-pine-surface relative group">
                                            <div className="absolute inset-0 flex items-center justify-center text-[10px] text-rose-pine-gold font-mono text-contrast">Logic</div>
                                        </div>
                                        {/* Serialization */}
                                        <div className="h-full bg-rose-pine-iris/20 w-[20%] relative group">
                                            <div className="absolute inset-0 flex items-center justify-center text-[10px] text-rose-pine-iris font-mono text-contrast">Serialize</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <div className="h-12 w-full flex rounded-lg overflow-hidden border border-rose-pine-love/30 bg-rose-pine-base/50">
                                            {/* Native Execution */}
                                            <div className="h-full bg-gradient-to-r from-rose-pine-love to-rose-pine-iris w-[25%] relative group shadow-[0_0_20px_rgba(235,111,146,0.3)]">
                                                <div className="absolute inset-0 flex items-center justify-center text-[10px] text-rose-pine-base font-bold font-mono uppercase">Bytecode Exec</div>
                                            ...
                                            <div className="flex-1 flex items-center px-4">
                                                <span className="text-[10px] text-rose-pine-subtle/50 font-mono italic text-contrast">Zero Serialization Overhead</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
