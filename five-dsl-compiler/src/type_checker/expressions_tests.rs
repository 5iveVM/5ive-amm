...
#[test]
fn test_infer_close_account_rejects_wrong_arity() {
    let mut checker = TypeCheckerContext::new();
    checker
        .symbol_table
        .insert("vault".to_string(), (TypeNode::Account, true));
    ...
    let node = AstNode::FunctionCall {
        name: "close_account".to_string(),
        args: vec![AstNode::Identifier("vault".to_string())],
    };
...
#[test]
fn test_infer_close_account_rejects_non_account_arguments() {
    let mut checker = TypeCheckerContext::new();
    checker
        .symbol_table
        .insert("value".to_string(), (TypeNode::Primitive("u64".to_string()), true));
    checker
        .symbol_table
        .insert("vault".to_string(), (TypeNode::Account, true));
