...
pub create_account(payer: account @signer, new_account: account @init, state: InitState @mut, initial_value: u64) -> pubkey {
...
pub get_created_count(state: InitState) -> u64 {
